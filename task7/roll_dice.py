...
def create_comparison_table(simulated_probabilities, theoretical_probabilities):
    ...
    data = {
        ...
        'Теоретична ймовірність (%)': [prob * 100 for prob in theoretical_probabilities.values()]
    }
...
# симуляція методом Монте-Карло продемонструвала високу точність, підтвердивши теоретичні розрахунки.
# Це ще раз підкреслює ефективність і надійність методу Монте-Карло для моделювання випадкових процесів.